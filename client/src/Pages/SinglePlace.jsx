...
const SinglePlace = () => {
    ...
    return (
        <div className='mx-auto w-7/12 mt-8'>
            ...
            {/* <div>
                    <img src={"https://luxereserve-hotel.onrender.com/uploads/" + place.photos[0]} alt="" className='rounded-l-xl h-full' />
                </div>
                <div className='grid lg:grid-cols-2 gap-2'>
                    <img src={"https://luxereserve-hotel.onrender.com/uploads/" + place.photos[1]} alt="" className='w-full h-full' />
                    <img src={"https://luxereserve-hotel.onrender.com/uploads/" + place.photos[2]} alt="" className='w-full h-full rounded-tr-xl' />
                    <img src={"https://luxereserve-hotel.onrender.com/uploads/" + place.photos[3]} alt="" className='w-full h-full' />
                    <img src={"https://luxereserve-hotel.onrender.com/uploads/" + place.photos[4]} alt="" className='w-full h-full rounded-br-xl' />
                </div> */}

            {/* <!-- Slider --> */}
            <div className='grid lg:grid-cols-4 gap-2' style={{height:"250px"} }>
                <img src={"https://luxereserve-hotel.onrender.com/uploads/" + place.photos[0]} alt="" className='w-full h-[250px]' />
                <img src={"https://luxereserve-hotel.onrender.com/uploads/" + place.photos[1]} alt="" className='w-full h-[250px]' />
                <img src={"https://luxereserve-hotel.onrender.com/uploads/" + place.photos[2]} alt="" className='w-full h-[250px]' />
                <img src={"https://luxereserve-hotel.onrender.com/uploads/" + place.photos[3]} alt="" className='w-full h-[250px]' />
            </div>
            {/* </div> */}
